...
import Profile from "../../assests/img/profile/profile1.jpeg";
          ...
          <Row className="pt-3 pb-5 align-items-center">
            ...
            <Col xs={12} md={6}>
              <Row className=" align-items-start p-2 my-details rounded">
                Hi there! I am <strong>&nbsp;Ajith Kumar </strong>
                ...
                <br />
                In 2019, I successfully completed my Engineering with specialization in 'Computer Science Enigineering '.
                <br />
